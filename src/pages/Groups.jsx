      ...
      <div className="flex flex-wrap items-center gap-2 w-full sm:w-auto sm:ml-auto">
        ...
        <div className="relative flex-1 sm:flex-none sm:w-64">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 bg-gray-800/50 border border-gray-700 rounded-xl text-gray-100 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500"
          />
        </div>
        ...
        <button
          ...
          className="px-3 sm:px-4 py-2.5 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white rounded-xl font-medium transition flex items-center justify-center gap-2 whitespace-nowrap"
        >
